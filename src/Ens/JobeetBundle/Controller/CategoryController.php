...
class CategoryController extends Controller
{
    ...
    /**
     * @Route("/{slug}/{page}" , defaults={"page" = 1})
     * 
     */
    function showAction($slug, $page)
    {
        ...
        $category->setActiveJobs($em->getRepository('EnsJobeetBundle:Job')->getActiveJobs($category->getId(), $jobs_per_page, 
